...
------------
find nearest greater element to right for all element in array,
...
2. and inner loop is used to find right nearest greater element
...
int main() {
	...
	find_NGR(arr, n);
	cout << "Printing the right nearest greater element : " << endl;
	for (int val : v) {
		cout << val << ", ";
	}
	cout << endl;
...
Output :-
-----------
Printing the right nearest greater element :
6, 10, 10, -1, -1,
